...
<body>
    <div class="selection-container">
        ...
        <div class="assessment-cards">
            <div class="assessment-card" data-type="mood" onclick="selectAssessment('mood', this)">
                <h3>😔 PHQ-9</h3>
            ...
            <div class="assessment-card" data-type="anxiety" onclick="selectAssessment('anxiety', this)">
                <h3>😰 GAD-7</h3>
            ...
            <div class="assessment-card" data-type="depression" onclick="selectAssessment('depression', this)">
                <h3>👴 GDS-15</h3>
