...
?>
<!DOCTYPE html>
<html lang="en" <?php echo $settings['high_contrast'] ? 'class="high-contrast"' : ''; ?>>
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Accessibility Settings - Elderly Care Platform</title>
    <link rel="stylesheet" href="/assets/css/header.css">
    <link rel="stylesheet" href="/assets/css/footer.css">
    <link rel="stylesheet" href="/assets/css/settings.css">
    <style>
        body {
            font-size: <?php echo $settings['large_font'] ? '120%' : '100%'; ?>;
        }
    </style>
</head>
<body>
        ...
        <form method="POST" action="">
            <div class="setting-card">
                ...
                <div class="toggle-switch">
                    <input type="checkbox" id="high_contrast" name="high_contrast" <?php echo $settings['high_contrast'] ? 'checked' : ''; ?>>
            ...
            <div class="setting-card">
                <div class="icon">🔤</div>
                <h2>Large Font</h2>
                <p>Makes all text 20% larger for easier reading.</p>
                <div class="toggle-switch">
                    <input type="checkbox" id="large_font" name="large_font" <?php echo $settings['large_font'] ? 'checked' : ''; ?>>
            ...
            <div class="setting-card">
                ...
                <div class="toggle-switch">
                    <input type="checkbox" id="voice_assistant" name="voice_assistant" <?php echo $settings['voice_assistant'] ? 'checked' : ''; ?>>
            ...
            <div class="setting-card">
                ...
                <div class="toggle-switch">
                    <input type="checkbox" id="tap_only_mode" name="tap_only_mode" <?php echo $settings['tap_only_mode'] ? 'checked' : ''; ?>>
